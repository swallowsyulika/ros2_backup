...
from lab2_pkg.srv import Img

class MinimalClientAsync(Node):

    def __init__(self):
        super().__init__('image_recognition_client')
        self.cli = self.create_client(Img, 'image_recog')
    ...
    def send_request(self):
        bridge = CvBridge()
        imagename=('/home/pi/ros2_ws/src/image_recog/image_recog/images/%s'%sys.argv[1])
